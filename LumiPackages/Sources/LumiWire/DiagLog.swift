...
///
/// GUI app'te stderr kaybolduğundan cihaz/saha teşhisi için düşük-frekanslı
/// kritik olaylar (spawn, launch-gate, remote bağlantı/komut, transcript claim)
/// dosyaya yazılır — Mac'te `~/.lumi/logs/mac.log`. Yazım serial queue'da
/// asenkrondur; sıcak yollarda (PTY chunk'ları vb.) KULLANMA, olay-frekanslı
/// çağrılar içindir. `configure` edilmemiş logger sessiz no-op'tur.
